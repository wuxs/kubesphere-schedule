...
func ParseGVKR(restMapper meta.RESTMapper, apiVersion string, kind string) (schedulev1alpha1.GroupVersionKindResource, error) {
	...
	if apiVersion == "" {
		...
		if err != nil {
			return schedulev1alpha1.GroupVersionKindResource{}, err
		}
	...
	return schedulev1alpha1.GroupVersionKindResource{
		Group:    group,
		Version:  version,
		Kind:     kind,
		Resource: resource,
